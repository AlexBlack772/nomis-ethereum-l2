// ------------------------------------------------------------------------------------------------------
// <copyright file="ArbitrumOneWalletStats.cs" company="Nomis">
...
{
    /// <summary>
    /// Arbitrum One wallet stats.
    /// </summary>
    public sealed class ArbitrumOneWalletStats :
        BaseEvmWalletStats<ArbitrumOneTransactionIntervalData>,
