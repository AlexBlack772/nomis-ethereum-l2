...
namespace Nomis.Arbiscan.Calculators
{
    ...
    internal sealed class ArbitrumOneStatCalculator :
        IWalletCommonStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletNativeBalanceStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletTokenBalancesStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletTransactionStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletTokenStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletContractStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletSnapshotStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletGreysafeStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletChainanalysisStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletCyberConnectStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletNftStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletAaveStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>,
        IWalletDexTokenSwapPairsStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>
    {
        ...
        /// <inheritdoc />
        public IList<ArbitrumOneTransactionIntervalData> TurnoverIntervals
        {
            get
            {
                ...
                return IWalletStatsCalculator<ArbitrumOneTransactionIntervalData>
        ...
        public decimal BalanceChangeInLastMonth =>
            IWalletStatsCalculator<ArbitrumOneTransactionIntervalData>.GetBalanceChangeInLastMonth(TurnoverIntervals);

        /// <inheritdoc />
        public decimal BalanceChangeInLastYear =>
            IWalletStatsCalculator<ArbitrumOneTransactionIntervalData>.GetBalanceChangeInLastYear(TurnoverIntervals);
        ...
        /// <inheritdoc />
        public ArbitrumOneWalletStats Stats()
        {
            return (this as IWalletStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>).ApplyCalculators();
        }

        /// <inheritdoc />
        IWalletTransactionStats IWalletTransactionStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>.Stats()
        {
            if (!_transactions.Any())
            {
                return new ArbitrumOneWalletStats
                {
                    NoData = true
                };
            }
        ...
        /// <inheritdoc />
        IWalletNftStats IWalletNftStatsCalculator<ArbitrumOneWalletStats, ArbitrumOneTransactionIntervalData>.Stats()
        {
