// ------------------------------------------------------------------------------------------------------
// <copyright file="GnosisWalletScore.cs" company="Nomis">
...
namespace Nomis.Gnosisscan.Interfaces.Models
{
    ...
    /// Gnosis wallet score.
    /// </summary>
    public class GnosisWalletScore :
        IWalletScore<GnosisWalletStats, GnosisTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public GnosisWalletStats? Stats { get; set; }
    }
}