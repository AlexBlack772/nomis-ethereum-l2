// ------------------------------------------------------------------------------------------------------
// <copyright file="GnosisWalletStats.cs" company="Nomis">
...
namespace Nomis.Gnosisscan.Interfaces.Models
{
    ...
    /// Gnosis wallet stats.
    /// </summary>
    public sealed class GnosisWalletStats :
        BaseEvmWalletStats<GnosisTransactionIntervalData>,
        IWalletDexTokenSwapPairsStats,
        IWalletNftStats
    {
        /// <inheritdoc/>
        public override string NativeToken => "XDAI";
