// ------------------------------------------------------------------------------------------------------
// <copyright file="GnosisStatCalculator.cs" company="Nomis">
...
namespace Nomis.Gnosisscan.Calculators
{
    /// <summary>
    /// Gnosis wallet stats calculator.
    /// </summary>
    internal sealed class GnosisStatCalculator :
        IWalletCommonStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletNativeBalanceStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletTokenBalancesStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletTransactionStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletTokenStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletContractStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletSnapshotStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletGreysafeStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletChainanalysisStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletCyberConnectStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletNftStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>,
        IWalletDexTokenSwapPairsStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>
    {
        private readonly string _address;
        private readonly IEnumerable<GnosisscanAccountNormalTransaction> _transactions;
        private readonly IEnumerable<GnosisscanAccountInternalTransaction> _internalTransactions;
        private readonly IEnumerable<IGnosisscanAccountNftTokenEvent> _tokenTransfers;
        private readonly IEnumerable<GnosisscanAccountERC20TokenEvent> _erc20TokenTransfers;
        ...
        /// <inheritdoc />
        public IList<GnosisTransactionIntervalData> TurnoverIntervals
        {
            get
            {
                ...
                return IWalletStatsCalculator<GnosisTransactionIntervalData>
        ...
        public decimal BalanceChangeInLastMonth =>
            IWalletStatsCalculator<GnosisTransactionIntervalData>.GetBalanceChangeInLastMonth(TurnoverIntervals);

        /// <inheritdoc />
        public decimal BalanceChangeInLastYear =>
            IWalletStatsCalculator<GnosisTransactionIntervalData>.GetBalanceChangeInLastYear(TurnoverIntervals);

        /// <inheritdoc />
        public decimal WalletTurnover =>
            _transactions.Sum(x => decimal.TryParse(x.Value, out decimal value) ? value.ToXdai() : 0);
        ...
        public GnosisStatCalculator(
            string address,
            decimal balance,
            decimal usdBalance,
            IEnumerable<GnosisscanAccountNormalTransaction> transactions,
            IEnumerable<GnosisscanAccountInternalTransaction> internalTransactions,
            IEnumerable<IGnosisscanAccountNftTokenEvent> tokenTransfers,
            IEnumerable<GnosisscanAccountERC20TokenEvent> erc20TokenTransfers,
        ...
        /// <inheritdoc />
        public GnosisWalletStats Stats()
        {
            return (this as IWalletStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>).ApplyCalculators();
        }

        /// <inheritdoc />
        IWalletTransactionStats IWalletTransactionStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>.Stats()
        {
            if (!_transactions.Any())
            {
                return new GnosisWalletStats
                {
                    NoData = true
                };
            }
        ...
        /// <inheritdoc />
        IWalletNftStats IWalletNftStatsCalculator<GnosisWalletStats, GnosisTransactionIntervalData>.Stats()
        {
            ...
            return new GnosisWalletStats
            {
                ...
                NftTrading = (soldSum - buySum).ToXdai(),
                NftWorth = nftWorth.ToXdai()
            };
        }
    }
}