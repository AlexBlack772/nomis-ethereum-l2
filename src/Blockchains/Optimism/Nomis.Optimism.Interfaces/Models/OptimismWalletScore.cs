// ------------------------------------------------------------------------------------------------------
// <copyright file="OptimismWalletScore.cs" company="Nomis">
...
{
    /// <summary>
    /// Optimism wallet score.
    /// </summary>
    public class OptimismWalletScore :
        IWalletScore<OptimismWalletStats, OptimismTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public OptimismWalletStats? Stats { get; set; }
    }
}