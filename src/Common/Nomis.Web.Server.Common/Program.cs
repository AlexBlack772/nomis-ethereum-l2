...
using Nomis.Api.ArbitrumOne.Extensions;
...
using Nomis.Api.Gnosis.Extensions;
using Nomis.Api.Greysafe.Extensions;
using Nomis.Api.Hapi.Extensions;
using Nomis.Api.Optimism.Extensions;
using Nomis.Api.Polygon.Extensions;
using Nomis.Api.Snapshot.Extensions;
using Nomis.Api.SoulboundToken.Extensions;
using Nomis.Api.ZkSync.Extensions;
using Nomis.Arbiscan;
...
using Nomis.Gnosisscan;
using Nomis.Greysafe;
using Nomis.HapiExplorer;
using Nomis.Optimism;
using Nomis.Polygonscan;
...
var scoringOptions = builder.ConfigureScoringOptions()
    ...
    .WithPolygonBlockchain<Polygonscan>()
    .WithArbitrumOneBlockchain<Arbiscan>()
    .WithGnosisBlockchain<Gnosisscan>()
    .WithOptimismBlockchain<Optimism>()
    .WithZkSyncBlockchain<Zkscan>()
